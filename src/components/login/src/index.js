 ...
 componentDidMount(){
  ...
  handleChange = e => {
    ...
    switch (name) {
      ...
      case "cidade":
        formErrors.cidade =
          value.length < 3 ? "cidade invalida" : "";
        break;
      case "telefone":
      ...
      case "estado":
        formErrors.estado =
          value.length < 3 ? "estado invalido" : "";
        break;
      case "email":
        ...
        <div>
          ...
          <form onSubmit={this.handleLogin} noValidate method = "POST" >
            ...
            <div className="createAccount">
              ...
              <small class="clique" onClick={this.handleClick}>Cadastre-se gratis!</small>
            </div>
          </form>
        </div>
      )
          ...
          <form onSubmit={this.handleSubmit} noValidate method = "POST">
           <div className="email">
            ...
            <div className="createAccount">
              ...
              <small class="clique" onClick={this.handleClick}>Fazer Login</small>
            </div>
          </form>
        </div>
      )
